...
const transactionSchema = new mongoose.Schema(
    {
        ...
        entityType: {
            type: String,
            enum: ['user', 'restaurant', 'deliveryBoy', 'contractor', 'admin'],
            required: true,
            index: true
        },
        ...
        category: {
            ...
            enum: [
                ...
                'referral_reward',
                'adjustment',
                // Quick Commerce: admin-funded rider fee for a customer return pickup.
                'return_pickup_fee',
                // Escrow (construction and any future staged-payment module).
                // A hold itself is NOT a transaction — no money moves — so there is
                // no 'escrow_hold' here; only an actual release or return appears.
                'escrow_release',
                'escrow_refund',
                'retention_release',
                'other'
