...
import { BikeVendor } from '../../modules/bike-rent/models/bikeVendor.model.js';
import { ContractorProfile } from '../../modules/construction/models/contractorProfile.model.js';
import { ServiceProviderProfile } from '../../modules/service-provider/models/serviceProviderProfile.model.js';
...
const OWNER_MODELS = {
    ...
    SELLER: Seller,
    QUICK_SELLER: Seller,
    BIKE_VENDOR: BikeVendor,
    VENDOR: BikeVendor,
    // Both of these carry `fcmTokens` on their profile and are targeted by
    // `notifyOwnerSafely`, but were missing here — so every push to a contractor
    // or a service provider failed at the model lookup and was swallowed by the
    // best-effort wrapper. Silent, and therefore invisible until someone asked
    // why they never got notified.
