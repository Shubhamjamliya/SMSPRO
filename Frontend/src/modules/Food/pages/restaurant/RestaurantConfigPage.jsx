  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20 md:pb-6">
      ...
      <div className="max-w-4xl mx-auto px-4 py-6 space-y-4">
        ...
        {/* Packaging charges are configured per menu item (Menu > item > Packaging
            charge) when admin enables restaurant-managed packaging. The old local-only
            "Extra Package Charge" block here was never saved anywhere and is gone. */}
