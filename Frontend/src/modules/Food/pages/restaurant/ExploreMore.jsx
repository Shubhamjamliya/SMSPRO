...
export default function ExploreMore() {
          ...
          return (
            ...
            >
              <motion.button
                ...
                className="w-full flex items-center justify-center p-5 bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 hover:border-[#FF6A00]/30 transition-colors duration-200 min-h-[90px]"
              >
                <div className="relative flex items-center justify-center">
                  {item.customIcon ? (
                    ...
                    <IconComponent className="w-7 h-7 text-[#FF6A00]" strokeWidth={1.5} />
                  )}
                  {item.badge && (
                    <motion.span
                      initial={{ scale: 0 }}
              ...
              <span className="text-xs text-gray-700 dark:text-gray-300 text-center leading-tight font-medium mt-2.5">
                {item.label}
              </span>
            </motion.div>
          )
  ...
  return (
    ...
    >
        ...
        >
          <div className="bg-white dark:bg-[#111] rounded-2xl border border-gray-100 dark:border-gray-800 p-4 mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#FF6A00]/10 rounded-xl flex items-center justify-center shrink-0">
        ...
        {logoutConfirmOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed inset-x-4 bottom-28 z-[61] mx-auto w-auto max-w-md rounded-3xl bg-white dark:bg-[#1a1a1a] p-5 shadow-2xl"
              onClick={(e) => e.stopPropagation()}
            >
        ...
        {searchOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 right-0 bg-white dark:bg-[#0a0a0a] shadow-lg z-50 h-screen"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Search Header */}
              <div className="flex items-center gap-3 px-4 py-3 border-b border-gray-100 dark:border-gray-800">
                ...
                <div className="flex-1 relative">
                  <input
                    ...
                    autoFocus
                    className="w-full px-4 py-2 pr-10 bg-gray-100 dark:bg-gray-800 rounded-xl focus:outline-none focus:ring-2 focus:ring-[#FF6A00]/30 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                  />
                  {searchQuery && (
                    <button
        ...
        {scheduleOffOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a1a] rounded-t-2xl shadow-2xl z-50 max-h-[90vh] overflow-y-auto"
              onClick={(e) => e.stopPropagation()}
            >
              {/* Header */}
              <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-800 sticky top-0 bg-white dark:bg-[#1a1a1a] z-10">
                <h2 className="text-base font-bold text-gray-900 dark:text-white">Select reason</h2>
                <button
                  onClick={() => setScheduleOffOpen(false)}
                  className="p-1.5 hover:bg-gray-100 rounded-lg transition-colors"
                  aria-label="Close"
