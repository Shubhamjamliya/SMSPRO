...
import { getInitialQuantity, getQuantityLimits } from "@food/utils/orderQuantity"
...
export default function ProductDetail() {
  ...
  const quantityLimits = getQuantityLimits(product)
  ...
  const handleIncrease = () => {
    if (inCart && cartItem) {
      if (cartItem.quantity >= quantityLimits.max) return
      updateQuantity(product.id, cartItem.quantity + 1)
    } else {
      setQuantity(prev => Math.min(quantityLimits.max, prev + 1))
    }
  }

  const handleDecrease = () => {
    if (inCart && cartItem) {
      // Below the item's minimum the line is removed (handled in CartContext).
      updateQuantity(product.id, cartItem.quantity - 1)
    } else {
      setQuantity(prev => Math.max(quantityLimits.min, prev - 1))
    }
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12">
        ...
        <div className="relative w-full h-[350px] sm:h-[400px] md:h-[450px] lg:h-[500px] xl:h-[550px] overflow-hidden rounded-lg md:rounded-xl lg:rounded-2xl mt-4 md:mt-6 lg:mt-8">
          ...
          <div className="absolute top-4 right-4 z-10">
            <Badge className="bg-[#FF6A00] text-white shadow-lg">
          ...
          <div className="absolute bottom-0 left-0 right-0 bg-white dark:bg-[#1a1a1a] rounded-t-3xl p-4 sm:p-5 md:p-6 lg:p-8">
            <div className="flex items-start gap-4 md:gap-6 lg:gap-8">
              ...
              <div className="flex-shrink-0 text-right">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-[#FF6A00]">
          ...
          <ScrollReveal>
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-xs sm:text-sm text-muted-foreground flex-wrap">
                <Link to="/user" className="hover:text-[#FF6A00] transition-colors">Home</Link>
                <span>/</span>
            ...
            <div className="space-y-4 pb-4 border-b">
              ...
              {inCart ? (
                <div className="flex items-center gap-4">
                  <div className="flex items-center gap-2 border border-[#FF6A00] rounded-lg">
                    <Button
                      variant="ghost"
                      size="icon"
                ...
                <div className="flex items-center gap-4">
                  ...
                  >
                    <Button
                      ...
                      className="bg-[#FF6A00] hover:opacity-90 text-white"
                    >
            ...
            <ScrollReveal delay={0.1}>
              <div className="space-y-3 md:space-y-4 pb-4 md:pb-6 border-b">
                <div className="flex items-center justify-between">
                  ...
                  <Badge className="bg-[#FF6A00] text-white text-sm md:text-base">{restaurant.priceRange}</Badge>
                </div>
                ...
                <div className="space-y-4 pb-4 border-b">
                  ...
                  <form onSubmit={handleSubmitReview} className="space-y-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        type="submit"
                        className="flex-1 bg-gradient-to-r bg-[#FF6A00] hover:from-red-600 hover:to-red-600"
                      >
