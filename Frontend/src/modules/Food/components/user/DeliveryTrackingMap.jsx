...
// Keep in sync with other customer maps (e.g. LiveTrackingMap) — mismatched
// `libraries` arrays crash @react-google-maps/api with "Loader must not be called again with different options".
...
const DeliveryTrackingMap = ({
  ...
  if (loadError) {
    return (
      <div className="w-full h-full min-h-[450px] bg-gradient-to-b from-gray-100 to-gray-200 flex items-center justify-center p-6 text-center">
        <p className="text-sm text-gray-600">Map could not be loaded. Tracking details are still available below.</p>
      </div>
    );
  }
