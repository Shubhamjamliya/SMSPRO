  ...
  },
  {
    ...
    items: [
      ...
      { type: "link", label: "Zone Setup", permissionKey: "zone_setup", path: "/admin/quick-commerce/zone-setup", icon: "MapPin" },
      {
        ...
        icon: "Megaphone",
        subItems: [
          { label: "Banner Management", path: "/admin/quick-commerce/banners", permissionKey: "banners" },
      ...
      { type: "link", label: "Customers", permissionKey: "customers", path: "/admin/quick-commerce/customers", icon: "Users" },
      {
        ...
        icon: "Bike",
        subItems: [
          { label: "Onboarding Requests", path: "/admin/quick-commerce/drivers/requests", permissionKey: "onboarding" },
          { label: "Drivers", path: "/admin/quick-commerce/drivers", permissionKey: "list" },
        ],
      },
