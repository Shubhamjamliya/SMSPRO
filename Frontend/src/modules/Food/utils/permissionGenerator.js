...
import { bikeRentAdminSidebarMenu } from "@/modules/bikeRent/admin/utils/bikeRentAdminSidebarMenu.js";
...
const ACTION_MAPPING = {
  ...
  driver_min_wallet: ["view", "edit"],
  dp_withdrawal_requests: ["view", "edit"],
...
export function generatePermissionTree(enabledModules = null) {
  const configs = [
    ...
    { root: "bikeRent", data: bikeRentAdminSidebarMenu, moduleKey: "bikeRent" },
