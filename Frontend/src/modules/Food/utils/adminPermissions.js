...
export const getAdminModuleConfig = (pathname = "") => {
  ...
  if (normalizedPath.startsWith("/admin/bike-rent")) {
    return { rootKey: "bikeRent", menu: bikeRentAdminSidebarMenu };
  }
...
const isModuleDashboardPath = (pathname = "", rootKey = "") => {
  ...
  if (rootKey === "bikeRent") return normalizedPath === "/admin/bike-rent";
  return false;
};
