    ...
    items: [
      ...
      },
      {
        ...
        subItems: [
          ...
          { label: "Pricing Management", path: "/admin/food/pricing", permissionKey: "list" },
        ],
      },
      {
        type: "expandable",
  ...
  */
  {
    ...
    items: [
      { type: "link", label: "Cash & Wallet Limits", permissionKey: "cash_limit", path: "/admin/food/delivery-cash-limit", icon: "IndianRupee" },
      ...
      { type: "link", label: "Packaging Charges", permissionKey: "fee_settings", path: "/admin/food/packaging-charges", icon: "Package" },
