...
export default function ViewZone() {
    ...
    return (
      <div className="flex min-h-[50vh] items-center justify-center bg-slate-50">
        <div className="text-center">
          ...
          <Button className="mt-4" onClick={() => navigate("/admin/porter/zones")}>
            Back to zones
          </Button>
        </div>
      </div>
  ...
  return (
    <FormPageShell
      ...
      actions={
        <Button onClick={() => navigate(`/admin/porter/zones/edit/${zone.id || id}`)}>
        ...
        <div className="xl:col-span-8">
          <div className="overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
            <div className="border-b border-slate-100 px-4 py-3">
              ...
              <p className="text-xs text-slate-500">Polygon boundary for this porter zone</p>
            </div>
