...
const Transactions = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `₹${(data?.balances?.returnRefundDeducted || 0).toLocaleString()}`,
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl sm:text-2xl font-black text-slate-900 flex items-center gap-2 flex-wrap">
              ...
              <Badge
                variant="primary"
                className="text-[10px] sm:text-xs px-1.5 py-0 font-bold tracking-wider uppercase bg-primary/10 text-primary">
                Audit Trail
              </Badge>
            </h1>
