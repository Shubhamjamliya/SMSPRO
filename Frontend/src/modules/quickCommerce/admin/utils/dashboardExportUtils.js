...
export function buildDashboardExportContext(statsData, { forPdf = false } = {}) {
  ...
  const overviewRows = [
    ...
    ['Total Returns', overview.totalReturns || 0, `${overview.activeReturns || 0} active`],
    ['Refunded To Customers', formatMoney(overview.refundedToCustomers), `${formatMoney(overview.refundsPending)} pending`],
  ];
