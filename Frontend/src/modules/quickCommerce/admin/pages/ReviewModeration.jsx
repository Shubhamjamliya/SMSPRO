                        ...
                        <div className="flex flex-col lg:flex-row gap-4 relative z-10">
                            ...
                            <div className="lg:w-64 shrink-0 space-y-4">
                                <div className="flex items-center gap-4">
                                    <div className="h-12 w-12 rounded-2xl bg-primary text-white flex items-center justify-center font-black ds-h2">
                                        {r.user[0]}
                                    </div>
                                    <div>
                            ...
                            <div className="lg:w-48 flex lg:flex-col items-center justify-center gap-3">
                                {r.status !== 'approved' && (
                                    <button
                                        ...
                                        className="flex-1 w-full flex items-center justify-center gap-2 py-3 bg-emerald-500 text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-lg shadow-emerald-200 hover:bg-emerald-600 transition-all active:scale-95"
                                    >
                                ...
                                <button
                                    ...
                                    className="flex-1 w-full flex items-center justify-center gap-2 py-3 bg-primary text-white rounded-2xl text-[10px] font-black uppercase tracking-widest shadow-xl hover:bg-primary/90 transition-all active:scale-95"
                                >
                                    REPLY
                                </button>
                            </div>
