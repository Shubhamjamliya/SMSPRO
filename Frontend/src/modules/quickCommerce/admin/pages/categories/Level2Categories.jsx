...
const Level2Categories = () => {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      if (editingItem) {
        ...
        toast.success(
          productsUpdated
            ? `Category updated, ${productsUpdated} products set ${formData.status}`
            : "Category updated",
        );
      } else {
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      toast.success(
        `Main category deleted${inactivated ? `, ${inactivated} products inactivated` : ""}`,
      );
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="flex justify-center">
                  <div
                    ...
                    className="w-24 h-24 rounded-full bg-gray-50 border-2 border-dashed border-gray-300 flex items-center justify-center cursor-pointer hover:border-primary overflow-hidden transition-colors">
                    {previewUrl ? (
                      <img
                        src={previewUrl}
                        alt="Preview"
            ...
            <motion.div
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-gray-500 text-sm mb-6">
                  ...
                  ? Linked products will become inactive (hidden from users).
                </p>
