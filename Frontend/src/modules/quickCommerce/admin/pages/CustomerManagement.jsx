...
const CustomerManagement = () => {
    ...
    const filterCustomers = (list) => {
        const safeCustomers = Array.isArray(list) ? list : [];
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            const payload = data?.result || {};
            const allCustomers = Array.isArray(payload.items) ? payload.items : (data?.results || []);
            const exportCustomers = filterCustomers(allCustomers);
            ...
            const downloaded = downloadCsv(
                buildCustomerCsvRows(exportCustomers),
