        ...
        <div className="ds-section-spacing animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 px-1">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button className="flex items-center gap-2 px-5 py-3 bg-primary text-white rounded-2xl text-xs font-bold hover:bg-primary/90 transition-all shadow-lg active:scale-95 group">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {[
                    ...
                    { label: 'Our Share', value: `₹${stats.totalCommission.toLocaleString()}`, icon: Percent, bg: 'bg-primary/5', color: 'text-slate-900' },
                    ...
                    <div className="ds-section-spacing">
                        <div className="flex flex-col items-center text-center p-6 bg-slate-50 rounded-xl border border-slate-100">
                            <div className={cn(
                                ...
                                selectedTxn.type === 'sale' ? "bg-primary/50" : selectedTxn.type === 'payout' ? "bg-emerald-500" : "bg-rose-500"
                            )}>
                        ...
                        <div className="space-y-6">
                            ...
                            {selectedTxn.type === 'sale' && (
                                <div className="space-y-4">
                                    ...
                                    <div className="bg-primary rounded-xl p-6 text-white space-y-4">
                                        ...
                                        <div className="flex justify-between items-center text-sm font-medium">
                                            ...
                                            <span className="text-red-400">-₹{selectedTxn.commissionAmount}</span>
                                        </div>
