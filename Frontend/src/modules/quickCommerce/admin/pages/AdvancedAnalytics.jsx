    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 pb-12">
                    ...
                    {['24h', '7d', '30d', '90d'].map((range) => (
                        <button
                            ...
                            className={cn(
                                ...
                                timeRange === range ? "bg-primary text-white shadow-lg" : "text-slate-400 hover:text-slate-600 hover:bg-slate-50"
                            )}
                        >
                            {range}
                        </button>
                    ...
                    <Card key={i} className="p-6 border-none shadow-xl ring-1 ring-slate-100 bg-white group hover:scale-[1.02] transition-all">
                        <div className="flex items-center justify-between mb-4">
                            <div className={cn("p-2.5 rounded-2xl",
                                goal.color === 'indigo' && "bg-indigo-50 text-primary",
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <Card className="border-none shadow-xl ring-1 ring-slate-100 bg-primary rounded-[32px] p-8 text-white overflow-hidden relative group">
                ...
                <Card className="border-none shadow-xl ring-1 ring-slate-100 bg-white rounded-[32px] p-8">
                    ...
                    <div className="space-y-3">
                        {[
                            ...
                            <div key={i} className="p-4 bg-slate-50 rounded-2xl border border-slate-100 flex items-center justify-between group hover:bg-primary hover:text-white transition-all">
                                <div>
