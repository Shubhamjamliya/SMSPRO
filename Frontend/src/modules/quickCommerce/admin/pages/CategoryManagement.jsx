...
const CategoryManagement = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Explicitly guarantee businessType is appended if it exists in state
            data.append('businessType', 'quick_commerce');
                            ...
                            <div style={{ paddingLeft: `${level * 24}px` }} className="flex items-center space-x-3">
                                ...
                                {item.image ? (
                                    ...
                                    <div className={cn(
                                        ...
                                        level === 0 ? "bg-primary/5 text-primary ring-2 ring-primary/10" :
        ...
        <div className="ds-section-spacing animate-in fade-in slide-in-from-bottom-2 duration-700 pb-16">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2 shrink-0">
                    ...
                    <button
                        ...
                        className="bg-primary text-white px-6 py-2.5 rounded-xl text-xs font-bold shadow-xl hover:bg-primary/90 transition-all hover:-translate-y-0.5 active:translate-y-0 flex items-center space-x-2"
                    >
            ...
            <div className="space-y-4">
                <div className="flex p-1 bg-white ring-1 ring-slate-100 rounded-2xl w-fit shadow-sm">
                    <button
                        ...
                        className={cn(
                            ...
                            activeView === 'tree' ? "bg-primary text-white shadow-lg" : "text-slate-400 hover:text-slate-600"
                        )}
                    >
                        Category Tree
                    </button>
                    <button
                        ...
                        className={cn(
                            "px-6 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all",
                            activeView === 'subcategories' ? "bg-primary text-white shadow-lg" : "text-slate-400 hover:text-slate-600"
                        )}
                    >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    ...
                    <Card className="lg:col-span-1 border-none shadow-sm ring-1 ring-primary/10 bg-gradient-to-tr from-primary/5 to-white p-4 flex flex-col justify-between overflow-hidden relative">
                        <div className="z-10">
                            <p className="ds-label text-primary/60 mb-1">
                                {activeView === 'tree' ? 'Total Groups' : 'Subcategories'}
                            </p>
                            <h4 className="ds-stat-medium text-slate-900 line-height-none">
                                {isLoading ? '...' : (activeView === 'tree' ? filteredCategories.length : filteredSubcategories.length)}
                            </h4>
                            <p className="text-[10px] font-semibold text-primary/60 mt-1">Working Fine</p>
                        </div>
                        {activeView === 'tree' ? (
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                        ...
                        <div className="bg-white/40 backdrop-blur-md rounded-xl p-0 ring-1 ring-slate-100 min-h-[500px] shadow-xl shadow-slate-200/40 overflow-hidden relative">
                            ...
                            <div className="p-6 border-b border-slate-50 bg-slate-50/50 flex items-center justify-between">
                                ...
                                <button
                                    ...
                                    className="text-[10px] font-black text-primary hover:text-primary uppercase tracking-widest flex items-center gap-2"
                                >
                                        ...
                                        {filteredSubcategories.map((sub) => {
                                            ...
                                            return (
                                                <tr key={id} className="hover:bg-slate-50/50 transition-colors group">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <Badge variant="outline" className="text-[9px] font-bold bg-primary/5 text-primary border-primary/15">
                                                    ...
                                                    <td className="px-6 py-4">
                                                        <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                            <button
                                                                ...
                                                                className="p-1.5 hover:bg-white text-slate-400 hover:text-primary rounded-lg transition-all shadow-sm ring-1 ring-slate-100 bg-white/50"
                                                            >
                                                                <Edit className="h-3.5 w-3.5" />
                                                            </button>
                                                            <button
                ...
                <div className="xl:col-span-4 space-y-6">
                    <Card className="bg-primary border-none shadow-xl p-6 rounded-xl text-white relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <div className="space-y-4">
                                {[
                                    { step: '1', title: 'Headers', desc: 'Main navigation groups (e.g., Grocery).', color: 'bg-primary/50' },
                        ...
                        <div className="absolute -right-4 -bottom-4 h-32 w-32 bg-primary/50/10 rounded-full blur-3xl" />
                    </Card>
                </div>
            </div>
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="flex gap-3 pt-2">
                                        ...
                                        <button
                                            onClick={handleSave}
                                            disabled={isSaving}
                                            className="flex-[2] py-3.5 rounded-xl text-xs font-black tracking-widest bg-primary text-white shadow-xl hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:translate-y-0 uppercase"
                                        >
